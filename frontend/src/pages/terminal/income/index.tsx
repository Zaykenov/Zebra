...
import { createTransaction, ShiftCategory, ShiftPostData } from "@api/shifts";

const TerminalIncomePage: NextPage = () => {
    ...
    <TerminalLayout>
      <div className="w-full flex items-center justify-center">
        <div className="w-full max-w-2xl p-4 rounded bg-gray-100 shadow-2xl border border-gray-300 flex flex-col">
          <div className="text-lg font-medium mb-4">Внесение</div>
          <form
...
export default TerminalIncomePage;
