...
namespace MobileApi.Sources.Migrations
{
    ...
    [Migration("20230721163714_coins-transactions-added")]
    partial class coinstransactionsadded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MobileApi.Sources.db.zebra.CalcCoinsTransactionModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("calc_coins_transaction", "mobile_api");
                });
            ...
            modelBuilder.Entity("MobileApi.Sources.db.zebra.CoinsTransactionModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal>("ZebraCoins")
                        .HasColumnType("numeric")
                        .HasColumnName("zebra_coins");

                    b.HasKey("Id");

                    b.ToTable("coins_transaction", "mobile_api");
                });
            ...
            modelBuilder.Entity("MobileApi.Sources.db.zebra.FeedbackModel", b =>
                {
                    ...
                    b.HasIndex("ScoreQuality");

                    b.HasIndex("ScoreService");
